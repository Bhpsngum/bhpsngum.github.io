        ...
        if (oldSize != this.size || init)
        {
          ...
          for (let i=0;i<this.size;i++)
          {
            ...
            for (let j=0;j<this.size;j++)
            {
              ...
              tb+=`<td id='p${i}-${j}' onmouseout ='Misc.set(${i},${j})' onclick = 'Misc.modify(${i},${j});' oncontextmenu='Misc.modify(${i},${j},0);' onmouseover='Misc.viewXY(${i},${j});' onmousedown='Misc.startTrail(${i},${j});' onmouseup='Misc.stopTrail()'><img class='ASFilter'src='Asteroid.png' draggable=false ondragstart="return false;" height='${wh*3}' width='${wh*3}'></td>`;
            }
            tb+="</tr>";
          }
          this.map.html(tb);
