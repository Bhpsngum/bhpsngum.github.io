(function(){
  ...
  created_time = {
    ...
    statinfo = `<h3 style="text-align:center"><a href="https://starblastio.gamepedia.com/${stat.title.replace(/\s/g,"_")}" target="_blank">${stat.title}</a> <sup>${stat.version}</sup></h3>${stat.new?'<b style="color:yellow;float:right">NEW!</b>':""}${!stat.active?'<b style="color:red;float:right">Removed</b>':""}`;
