(function(){
  ...
  window.document.body.setAttribute("style", "color:"+(styles[i][ind]||"rgb(102,102,102)"));
  ...
  function testImage(i)
  {
    ...
    u.src = lnk;
    img.onload = function(){
      window.document.body.setAttribute("style",window.document.body.getAttribute("style")+`background-image:url(${lnk});`);
